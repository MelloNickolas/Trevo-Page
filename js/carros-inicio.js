...
function criarCard(carro) {
  ...
  card.innerHTML = `
    ...
    <div class="card-topics">
      <div class="topic">
        <img src="../assets/imgs/Calendar.svg" height="20px">
        <h5 class="font-league-12 neutro-9">${carro.ano}</h5>
      </div>
      <div class="topic">
        <img src="../assets/imgs/Value.svg" height="20px">
        <h5 class="font-league-12 neutro-9">${carro.preco}</h5>
      </div>
    </div>
    <div class="card-buttons">
      <a href="" class="font-league-12 neutro-6">Ver Mais</a>
      <a href="" class="font-league-12 neutro-0">Comprar</a>
    </div>
  `;
  return card;
}

fetch('../dados/Carros-Inicio.json')
